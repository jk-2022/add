...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1362: x0 => x0.remove(),
      _1363: () => ({}),
      _1364: (x0,x1,x2) => new File(x0,x1,x2),
      _1365: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1365(f,arguments.length,x0) }),
      _1366: (x0,x1,x2) => globalThis.jsConnect(x0,x1,x2),
      _1367: (x0,x1) => globalThis.jsSend(x0,x1),
      _1368: x0 => globalThis.jsDisconnect(x0),
      _1369: x0 => x0.decode(),
      ...
      _1376: x0 => globalThis.Wakelock.toggle(x0),
      _1377: () => globalThis.Wakelock.enabled(),
      _1378: (x0,x1) => x0.getItem(x1),
      _1379: (x0,x1) => x0.removeItem(x1),
      _1380: (x0,x1,x2) => x0.setItem(x1,x2),
      _1381: x0 => ({frequency: x0}),
      _1382: x0 => new Accelerometer(x0),
      _1383: x0 => x0.start(),
      ...
      _1390: x0 => new LinearAccelerationSensor(x0),
      _1391: x0 => x0.start(),
      ...
      _1398: (x0,x1) => x0.querySelector(x1),
      _1399: x0 => ({type: x0}),
      _1400: (x0,x1) => new Blob(x0,x1),
      _1401: x0 => globalThis.URL.createObjectURL(x0),
      _1402: (x0,x1) => x0.item(x1),
      _1403: () => new FileReader(),
      _1405: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1406: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1406(f,arguments.length,x0) }),
      _1407: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1414: x0 => globalThis.URL.revokeObjectURL(x0),
      _1415: (x0,x1,x2) => x0.slice(x1,x2),
      _1416: x0 => x0.deviceMemory,
      _1417: x0 => x0.getBattery(),
      _1418: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1418(f,arguments.length,x0) }),
      _1419: () => globalThis.removeSplashFromWeb(),
      _1421: (x0,x1) => x0.matchMedia(x1),
      _1424: x0 => x0.pyodide,
      _1427: x0 => x0.webSocketEndpoint,
      _1428: x0 => x0.routeUrlStrategy,
      _1433: () => globalThis.flet,
      _1434: Date.now,
      ...
      _1439: () => typeof dartUseDateNowForTicks !== "undefined",
      _1440: () => 1000 * performance.now(),
      _1441: () => Date.now(),
      _1442: () => {
      ...
      _1444: () => new WeakMap(),
      _1445: (map, o) => map.get(o),
      _1446: (map, o, v) => map.set(o, v),
      _1447: x0 => new WeakRef(x0),
      _1448: x0 => x0.deref(),
      _1449: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1449(f,arguments.length,x0) }),
      _1450: x0 => new FinalizationRegistry(x0),
      _1451: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1453: (x0,x1) => x0.unregister(x1),
      _1455: () => globalThis.WeakRef,
      _1456: () => globalThis.FinalizationRegistry,
      _1459: s => JSON.stringify(s),
      _1460: s => printToConsole(s),
      ...
      _1472: Object.is,
      _1473: o => o instanceof Array,
      _1474: (a, i) => a.push(i),
      _1475: (a, i) => a.splice(i, 1)[0],
      _1476: (a, i, v) => a.splice(i, 0, v),
      _1477: (a, l) => a.length = l,
      _1478: a => a.pop(),
      _1479: (a, i) => a.splice(i, 1),
      _1480: (a, s) => a.join(s),
      _1481: (a, s, e) => a.slice(s, e),
      _1482: (a, s, e) => a.splice(s, e),
      _1483: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1484: a => a.length,
      _1485: (a, l) => a.length = l,
      _1486: (a, i) => a[i],
      _1487: (a, i, v) => a[i] = v,
      _1489: o => {
      ...
      _1490: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1492: o => o instanceof Uint8Array,
      _1493: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1494: o => o instanceof Int8Array,
      _1495: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1496: o => o instanceof Uint8ClampedArray,
      _1497: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1498: o => o instanceof Uint16Array,
      _1499: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1500: o => o instanceof Int16Array,
      _1501: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1502: o => o instanceof Uint32Array,
      _1503: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1504: o => o instanceof Int32Array,
      _1505: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1507: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1508: o => o instanceof Float32Array,
      _1509: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1510: o => o instanceof Float64Array,
      _1511: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1512: (t, s) => t.set(s),
      _1513: l => new DataView(new ArrayBuffer(l)),
      _1514: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1515: o => o.byteLength,
      _1516: o => o.buffer,
      _1517: o => o.byteOffset,
      _1518: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1519: (b, o) => new DataView(b, o),
      _1520: (b, o, l) => new DataView(b, o, l),
      _1521: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1522: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1523: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1524: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1525: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1526: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1527: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1528: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1529: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1530: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1531: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1532: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1533: Function.prototype.call.bind(DataView.prototype.getBigUint64),
      _1535: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1536: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1537: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1538: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1539: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1540: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1553: (ms, c) =>
      ...
      _1592: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1592(f,arguments.length,x0,x1) }),
      _1593: o => {
      ...
      _1651: x0 => x0.cancel(),
      _1652: x0 => x0.read(),
      _1653: (x0,x1,x2,x3) => ({method: x0,headers: x1,body: x2,credentials: x3}),
      _1654: (x0,x1,x2) => x0.fetch(x1,x2),
      _1655: (x0,x1) => x0.key(x1),
      _1656: x0 => x0.random(),
      _1657: (x0,x1) => x0.getRandomValues(x1),
      _1658: () => globalThis.crypto,
      _1659: () => globalThis.Math,
      _1669: Function.prototype.call.bind(Number.prototype.toString),
      _1670: Function.prototype.call.bind(BigInt.prototype.toString),
      _1671: Function.prototype.call.bind(Number.prototype.toString),
      _1672: (d, digits) => d.toFixed(digits),
      _1676: () => globalThis.document,
      _1677: () => globalThis.window,
      _1682: (x0,x1) => { x0.height = x1 },
      _1684: (x0,x1) => { x0.width = x1 },
      _1687: x0 => x0.head,
      _1688: x0 => x0.classList,
      _1692: (x0,x1) => { x0.innerText = x1 },
      _1693: x0 => x0.style,
      _1695: x0 => x0.sheet,
      _1696: x0 => x0.src,
      _1697: (x0,x1) => { x0.src = x1 },
      _1698: x0 => x0.naturalWidth,
      _1699: x0 => x0.naturalHeight,
      _1706: x0 => x0.offsetX,
      _1707: x0 => x0.offsetY,
      _1708: x0 => x0.button,
      _1715: x0 => x0.status,
      _1716: (x0,x1) => { x0.responseType = x1 },
      _1718: x0 => x0.response,
      _1767: (x0,x1) => { x0.responseType = x1 },
      _1768: x0 => x0.response,
      _1828: (x0,x1) => { x0.draggable = x1 },
      _1844: x0 => x0.style,
      _2201: (x0,x1) => { x0.target = x1 },
      _2203: (x0,x1) => { x0.download = x1 },
      _2228: (x0,x1) => { x0.href = x1 },
      _2321: (x0,x1) => { x0.src = x1 },
      ...
      _3610: x0 => x0.navigator,
      _3614: x0 => x0.screen,
      _3617: x0 => x0.innerHeight,
      _3621: x0 => x0.screenLeft,
      _3625: x0 => x0.outerHeight,
      _3873: x0 => x0.sessionStorage,
      _3874: x0 => x0.localStorage,
      _3983: x0 => x0.maxTouchPoints,
      _3990: x0 => x0.appCodeName,
      _3991: x0 => x0.appName,
      _3992: x0 => x0.appVersion,
      _3993: x0 => x0.platform,
      _3994: x0 => x0.product,
      _3995: x0 => x0.productSub,
      _3996: x0 => x0.userAgent,
      _3997: x0 => x0.vendor,
      _3998: x0 => x0.vendorSub,
      _4000: x0 => x0.language,
      _4001: x0 => x0.languages,
      _4002: x0 => x0.onLine,
      _4007: x0 => x0.hardwareConcurrency,
      _4047: x0 => x0.data,
      _4204: x0 => x0.length,
      _4421: x0 => x0.readyState,
      _4430: x0 => x0.protocol,
      _4434: (x0,x1) => { x0.binaryType = x1 },
      _4437: x0 => x0.code,
      _4438: x0 => x0.reason,
      _6105: x0 => x0.type,
      _6146: x0 => x0.signal,
      _6158: x0 => x0.length,
      _6207: x0 => x0.firstChild,
      _6218: () => globalThis.document,
      _6300: x0 => x0.body,
      _6302: x0 => x0.head,
      _6631: x0 => x0.id,
      _6632: (x0,x1) => { x0.id = x1 },
      _6659: x0 => x0.children,
      _7977: x0 => x0.value,
      _7979: x0 => x0.done,
      _8159: x0 => x0.size,
      _8160: x0 => x0.type,
      _8163: (x0,x1) => { x0.type = x1 },
      _8166: x0 => x0.name,
      _8172: x0 => x0.length,
      _8177: x0 => x0.result,
      _8673: x0 => x0.url,
      _8675: x0 => x0.status,
      _8677: x0 => x0.statusText,
      _8678: x0 => x0.headers,
      _8679: x0 => x0.body,
      _8961: x0 => x0.matches,
      _8974: x0 => x0.width,
      _8975: x0 => x0.height,
      _10807: (x0,x1) => { x0.border = x1 },
      _11085: (x0,x1) => { x0.display = x1 },
      _11249: (x0,x1) => { x0.height = x1 },
      _11939: (x0,x1) => { x0.width = x1 },
      _12230: x0 => x0.charging,
      _12233: x0 => x0.level,
      _12235: (x0,x1) => { x0.onchargingchange = x1 },
      _12307: x0 => x0.name,
      _12308: x0 => x0.message,
      _13050: x0 => x0.x,
      _13051: x0 => x0.y,
      _13052: x0 => x0.z,
      _13053: (x0,x1) => { x0.onreading = x1 },
      _13054: (x0,x1) => { x0.onerror = x1 },
      _13055: x0 => x0.x,
      _13056: x0 => x0.y,
      _13057: x0 => x0.z,
      _13058: (x0,x1) => { x0.onreading = x1 },
      _13059: (x0,x1) => { x0.onerror = x1 },
      _13060: x0 => x0.x,
      _13061: x0 => x0.y,
      _13062: x0 => x0.z,
      _13063: (x0,x1) => { x0.onreading = x1 },
      _13064: (x0,x1) => { x0.onerror = x1 },
      _13065: x0 => x0.x,
      _13066: x0 => x0.y,
      _13067: x0 => x0.z,
      _13068: (x0,x1) => { x0.onreading = x1 },
      _13069: (x0,x1) => { x0.onerror = x1 },
      _13070: x0 => x0.error,
      _13071: x0 => x0.name,
