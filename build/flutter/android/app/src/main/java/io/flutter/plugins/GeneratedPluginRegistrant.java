...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.flet.serious_python_android.AndroidPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin serious_python_android, com.flet.serious_python_android.AndroidPlugin", e);
    }
    try {
